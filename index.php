...
<html>
    <head>
        <title>FolderCreator - Library to create folders</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container">
            <div class="container-header">
                <h3>FolderCreator</h3>
                <h4>FolderCreator - Library to create folders</h4>
            </div>
            <!-- Result -->
            <div class="form-result">
                <pre><?php var_dump(new helionogueir\foldercreator\folder\Create()); ?></pre>
            </div>
            <!-- /Result -->
        </div>
    </body>
